 ...
 CREATE TABLE account_details
   (  
    ...
    CONSTRAINT account_id_fk FOREIGN KEY(customer_id) REFERENCES customer_details(customer_id) on update cascade); 
      ...
      alter table account_details alter status  set default 'Activate';
    ...
    (   
     ...
     transaction_amount bigint(7),    
     CONSTRAINT tnumber_pk PRIMARY KEY(tranasction_number),
     CONSTRAINT acnumber_fk FOREIGN KEY(account_number) REFERENCES account_details(account_number)  
    );
      
       INSERT INTO customer_details(full_name,city) VALUES('Dhatchinamoorthi','karaikudi');
       INSERT INTO customer_details(full_name,city) VALUES('Janet','karur');
